...
namespace mei {
    ...
    struct ReportingConfig {
        ...
        // How much of the seeing history the plot retains. Presentation only --
        // it does not affect what is measured, published or logged.
        double historyWindowS = 1800.0;   // 30 minutes

        // Display only. Files and the Alpaca payload stay in UTC regardless: a
        // dataset carrying local times is ambiguous the moment it leaves the
        // machine that produced it, and worse across a DST boundary.

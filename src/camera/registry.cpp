...
namespace mei {
    ...
    CameraRegistry::CameraRegistry() {
        ...
        // Replay is a frame source, not a viewer: a recorded capture runs the same
        // acquisition, centroiding, statistics and publishing path as a live
        // camera, which is what makes reprocessing possible at all.
        backends_.push_back(makeSerBackend());
